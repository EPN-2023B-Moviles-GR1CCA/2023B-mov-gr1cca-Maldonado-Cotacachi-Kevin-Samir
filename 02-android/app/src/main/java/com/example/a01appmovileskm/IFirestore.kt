...
class IFirestore : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonFirebaseEliminar.setOnClickListener {
            eliminarRegistro() }
        // Empezar a paginar
        //Esta funcion borra el ultimo registro que teniamos guardado
        ...
        // Paginar
        //Sigue mandando el curso al sigueinte registro
    ...
    //Para paginar en cualquier collecion
    ...
    fun crearEjemplo() {
        ...
        referenciaEjemploEstudiante // (crear/actualizar)
            ...
            .addOnSuccessListener { }
            .addOnFailureListener { }
        // Sin IDENTIFICADOR (crear) //Crea el identificador automatico con el add
        referenciaEjemploEstudiante
            .add(datosEstudiante)
