package com.example.uber_cliente_proyecto.Adapter
...
import com.example.uber_cliente_proyecto.DetalleHistorial
...
class HistorialAdapter(val context: Activity, val histories: ArrayList<Historial>) : RecyclerView.Adapter<HistorialAdapter.HistoriesAdapterViewHolder>(){
    ...
    override fun onBindViewHolder(holder: HistoriesAdapterViewHolder, position: Int) {
        ...
        holder.textViewOrigin.text = history.origen
        holder.textViewDestination.text = history.destino
    ...
    private fun goToDetail(idHistory: String) {
        val i = Intent(context, DetalleHistorial::class.java)
