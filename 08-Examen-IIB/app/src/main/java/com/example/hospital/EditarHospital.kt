...
class EditarHospital : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Hospital().getHospitalById(codigoHospital) { hospital ->
            hospital?.let {
                ...
                Log.e("EditarHospital", "No se encontró el hospital con ID: $codigoHospital")
                Toast.makeText(this, "No se encontró el hospital con ID: $codigoHospital", Toast.LENGTH_LONG).show()
                finish() // Cerrar la actividad si no se encuentra el hospital
            }
        }
    }
}
