...
import ModalBottomSheetBooking
...
import com.example.uber_conductor.Fragmentos.ModalBottomSheetMenu
import com.example.uber_conductor.Modelos.Reserva
import com.example.uber_conductor.databinding.ActivityMapaConductorBinding
...
class MapaConductor : AppCompatActivity() , OnMapReadyCallback, Listener, SensorEventListener {

    private var bearing: Float = 0.0f
    private var bookingListener: ListenerRegistration? = null
    private lateinit var binding: ActivityMapaConductorBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapaConductorBinding.inflate(layoutInflater)
...
//                    easyWayLocation?.startLocation();
    ...
    private fun showModalBooking(booking: Reserva) {
        ...
        bookingListener = bookingProvider.getBooking().addSnapshotListener { snapshot, e ->
            ...
            if (snapshot != null) {
                if (snapshot.documents.size > 0) {
                    val booking = snapshot.documents[0].toObject(Reserva::class.java)
