package com.example.uber_conductor.Adapter
...
import com.example.uber_conductor.DetalleHistorial
...
class HistoriesAdapter(val context: Activity, val histories: ArrayList<HistorialViaje>): RecyclerView.Adapter<HistoriesAdapter.HistoriesAdapterViewHolder>() {
